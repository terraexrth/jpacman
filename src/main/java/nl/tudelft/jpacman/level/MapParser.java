...
public class MapParser {
	...
	protected void addSquare(Square[][] grid, List<Ghost> ghosts,
		...
		switch (c) {
			case ' ':
				grid[x][y] = boardCreator.createGround(this.level);
				break;
			case '#':
				grid[x][y] = boardCreator.createWall(this.level);
				break;
			case '.':
			...
			case 'G':
				...
				break;
			case 'P':
				Square playerSquare = boardCreator.createGround(this.level);
	...
	protected Square makeGhostSquare(List<Ghost> ghosts, Ghost ghost) {
		Square ghostSquare = boardCreator.createGround(this.level);
		ghosts.add(ghost);
