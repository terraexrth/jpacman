...
public class Tutorial extends JFrame {
	...
	public Tutorial() {
		...
		ImageIcon backgroundImage = new ImageIcon("src/main/resources/tutorial_ep_bg.png");
		...
		ImageIcon continueIcon = new ImageIcon("src/main/resources/continue_btn.png");
		...
		ImageIcon backIcon = new ImageIcon("src/main/resources/back_btn.png");
