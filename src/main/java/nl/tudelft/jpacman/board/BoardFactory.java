...
public class BoardFactory {
	 ...
	 */
	public Square createGround(int level) {
		return new Ground(sprites.getGroundSprite(level));
	}
	 ...
	 */
	public Square createWall(int level) {
		return new Wall(sprites.getWallSprite(level));
	}
